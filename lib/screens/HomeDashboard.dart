  ...
  Future<void> _loadUserData() async {
    try {
      ...
      QuerySnapshot sessions = await FirebaseFirestore.instance
          ...
          .get();
      setState(() {
        _completedSessions = sessions.docs.length;
      });
    } catch (e) {
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // ✅ زر الجرس مربوط بـ ExerciseReminder
                    GestureDetector(
                      onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "You've completed $_completedSessions of $_totalSessions recovery\nsessions. Keep the momentum going!",
                            style: AppTextStyles.bodyLarge,
                          ),
                          const SizedBox(height: 28),
                          Container(
                            ...
                            child: const Text("Resume Exercises",
                    ...
                    buildFeatureCard(context,
                        ...
                        iconColor: const Color(0xff005FAF),
                        ...
                        footer: "8 Games",
                        footerColor: const Color(0xff005FAF)),
                    const SizedBox(height: 40),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        const Text("Weekly Outlook",
                            style: TextStyle(
                              fontSize: 22,
                              fontWeight: FontWeight.w600,
                              color: Color(0xff1A1C1C),
        ...
        child: Row(
          ...
          children: [
            GestureDetector(
              ...
              child: navItem(icon: Icons.home, label: "Home", active: true),
            ),
            GestureDetector(
              onTap: () => Navigator.push(
                  context,
              ...
              child:
                  navItem(icon: Icons.back_hand_outlined, label: "Exercises"),
            ),
            GestureDetector(
              onTap: () => Navigator.push(context,
                  MaterialPageRoute(builder: (_) => const CognitiveGame())),
              child: navItem(icon: Icons.psychology_outlined, label: "Games"),
            ),
            GestureDetector(
              onTap: () => Navigator.push(
                  context,
              ...
              child: navItem(icon: Icons.auto_graph, label: "Progress"),
            ),
          ],
        ),
      ),
          ...
          GestureDetector(
            ...
            child: Row(
              ...
              children: [
                Text(footer,
                    style: AppTextStyles.bodyLarge.copyWith(
                        color: footerColor, fontWeight: FontWeight.bold)),
                const SizedBox(width: 6),
                Icon(Icons.arrow_forward, color: footerColor),
              ],
            ),
          ),
        ],
